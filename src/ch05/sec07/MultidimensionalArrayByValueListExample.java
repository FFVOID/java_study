...
public class MultidimensionalArrayByValueListExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("2차원 배열 길이(첫번쨰 반의 학생수):" + scores[0].length);
		System.out.println("2차원 배열 길이(두번쨰 반의 학생수):" + scores[1].length);
		...
		System.out.println("첫번째 반 평균" + (double) class2Sum / scores[1].length);
		...
		System.out.println("전체 학생수:" + totalStudent);
